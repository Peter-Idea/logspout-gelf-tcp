...
This module allows Logspout to send Docker logs in the GELF format to Graylog via TCP.

It's modify https://github.com/micahhausler/logspout-gelf

## Build
To build, you'll need to fork [Logspout](https://github.com/gliderlabs/logspout), add the following code to `modules.go` 

```
_ "github.com/Peter-Idea/logspout-gelf-tcp"
```
